        ...
        <div class="col-10 col-md-6 offset-1 offset-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="username-control" name="phone" value="{{$user->username}}">
                    ...
                    <input type="textarea" class="introduction-control" name="phone" value="{{$user->introduction}}">
                    <p>変更前ファイル：</p>
